...
to C++17 and as of UE4.27 C++20 is not that painful either (you'll need to ask for
`CppStandardVersion.Latest` and possibly disable shared PCHs).
...
# Appendix A: GetName/LexToString C++17 solutions
