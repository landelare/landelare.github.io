...
For the purists it might be news that Epic updated the UE coding conventions and 
`<type_traits>` is now [fair game](https://docs.unrealengine.com/5.0/en-US/epic-cplusplus-coding-standardblueprint-debugging-in-unreal-engine/#useofstandardlibraries).
